          ...
          >
            <ul className="mt-4 flex flex-col font-medium md:mt-0 md:flex-row md:space-x-8">
              <li>
                <a
                  href="#"
                  className="block border-b border-gray-100 py-2 pl-3 pr-4 text-blue-600 hover:bg-gray-50 dark:border-gray-700 dark:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:border-0 md:p-0 md:hover:bg-transparent md:hover:text-blue-600 md:dark:hover:bg-transparent md:dark:hover:text-blue-500"
                  aria-current="page"
                >
                  Home
                </a>
              ...
              <li>
                <button
                  ...
                  className="flex w-full items-center justify-between border-b border-gray-100 py-2 pl-3 pr-4 font-medium text-gray-900 hover:bg-gray-50 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700 dark:hover:text-blue-500 md:w-auto md:border-0 md:p-0 md:hover:bg-transparent md:hover:text-blue-600 md:dark:hover:bg-transparent md:dark:hover:text-blue-500"
                >
                  Company
                  <svg
                    aria-hidden="true"
                ...
                <div
                  ...
                  className="absolute z-10 grid hidden w-auto grid-cols-2 rounded-lg border border-gray-100 bg-white text-sm shadow-md dark:border-gray-700 dark:bg-gray-700 md:grid-cols-3"
                >
                  <div className="p-4 pb-0 text-gray-900 dark:text-white md:pb-4">
                    ...
                    >
                      <li>
                        <a
                          href="#"
                          className="group flex items-center text-gray-500 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-500"
                        >
                          <span className="sr-only">About us</span>
                          <svg
                            className="mr-2 h-4 w-4 text-gray-400 group-hover:text-blue-600 dark:text-gray-500 dark:group-hover:text-blue-500"
                            aria-hidden="true"
                            focusable="false"
                            fill="currentColor"
                            viewBox="0 0 20 20"
